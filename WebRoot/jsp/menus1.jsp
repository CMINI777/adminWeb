...
<head>
  ...
  <!-- 为本页表格自定义的样式 -->
  <link rel="stylesheet" href="<%=basePath%>resources/adminCss/mydatatables.css">
</head>
...
<!-- 日期控件 -->
<script type="text/javascript" src="<%=basePath%>plugins/adminLTE/plugins/laydate/laydate.js"></script>
<!-- 本页js -->
<script src="<%=basePath%>resources/adminJS/menus.js"></script>
</body>
</html>