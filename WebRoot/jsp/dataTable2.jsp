...
<!-- DataTables -->
<script src="<%=basePath%>plugins/adminLTE/plugins/datatables/jquery.dataTables-1.10.5.min.js"></script><!-- 这里必须得是1.10.5这一个版本，否则在显示隐藏列后，由于缺失style这个属性导致页面中的列显示错乱 -->
<script src="<%=basePath%>plugins/adminLTE/plugins/datatables/dataTables.bootstrap.min.js"></script>
<!-- page script -->
<script src="<%=basePath%>resources/adminJS/dataTable2.js"></script>
</body>
</html>